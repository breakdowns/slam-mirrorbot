...
- **IS_TEAM_DRIVE**: Set to `True` if `GDRIVE_FOLDER_ID` is from a Team Drive else `False` or Leave it empty. It is preferred to use Team Drive . You can get free TDs from [HERE](https://td.msgsuite.workers.dev) !
