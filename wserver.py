...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/breakdowns/slam-tg-mirrorbot"><i class="fab fa-github"></i></a>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See slam-mirrorbot <a href='https://github.com/breakdowns/slam-tg-mirrorbot'>@GitHub</a> By <a href='https://github.com/breakdowns'>Breakdowns</a></h1>", content_type="text/html")
