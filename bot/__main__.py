...
/{BotCommands.MirrorCommand} [download_url][magnet_link]: Start mirroring the link to Google Drive. Use /mirror qb to mirror with qbitorrent, and use /mirror qbs to select files before downloading
