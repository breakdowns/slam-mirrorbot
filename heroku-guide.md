...
1. Give stars and Fork this repo then upload **token.pickle** to your forks, or you can upload your **token.pickle** to your Index and put your **token.pickle** link to **TOKEN_PICKLE_URL** (**NOTE**: If you didn't upload **token.pickle** uploading will not work).
...
3. Add the below Required Variables one by one by clicking `New Repository Secret` everytime.
	...
	* `CONFIG_FILE_URL` You must upload your `config.env` to https://gist.github.com, Check the steps here:
