...
- **SUDO_USERS**: Fill user_id (not username) of you want to sudoers, Seprate them with space, Examples: ```0123456789 1122334455 6915401739```, (**NOTE**: If you want save sudo id permanent with database, you must fill your sudo id there).
